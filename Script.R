...
#leitura de árvore
read.nexus("17 Espécies.nex")->MRTD
#selecionar as árvores
MRTD[[1]]->AllEqual1.0
MRTD[[6]]->Rho0.2
...
#Associar nomes com cada variável
...
#checar classes de variáves
str(dadosMRTD)

#checar correspondecia entre árvores e o dados
name.check(AllEqual1.0,df.dadosMRTD)
name.check(Rho0.2,df.dadosMRTD)

#Sinal Filogenético K (Blomberg)
phylosignal(Massa,AllEqual1.0)#primeiro variável, depois árvore
...
summary(PCA.MRTD)#proporção cumulativa
...
#regressão dos contrastes pela origem (-1)
